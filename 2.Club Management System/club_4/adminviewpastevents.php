			...
			<table border="2" class="tbl-border">
				<tr>
					...
					<td width="785" valign="top">
							...
							<label class="mylabel"><u>Past Events:</u></label> <br /><br />
							
							<?php 
							$query = "SELECT * FROM events where event_status = 0 ";
							...
							$tbl = "<table border='1' cellspacing='0' cellpadding='5' align = 'center' width='600'>
								...
								while($row = mysql_fetch_array($result))
								{
									...
									//$status = $row['status'];
									 ...
									 $tbl .= "<tr height='35'><td>" . $eventid . "</td>"."<td>" . $eventname . "</td>" . "<td>" . $eventdesc . "</td>" . "<td>" . $eventdate . "</td><td>Closed</td></tr>";
