							...
							$tbl = "<table border='1' cellspacing='0' cellpadding='5' align = 'center' width='600'>
								...
								while($row = mysql_fetch_array($result))
								{
									...
									//$status = $row['status'];
									 ...
									 $tbl .= "<tr height='35'><td>" . $eventid . "</td>"."<td>" . $eventname . "</td>" . "<td>" . $eventdesc . "</td>" . "<td>" . $eventdate . "</td><td><a href='closeevent.php?event_id=$eventid'><button class='mybutton'>Close</button></a></td></tr>";
