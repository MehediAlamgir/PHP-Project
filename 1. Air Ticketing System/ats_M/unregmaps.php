<?php
    ...
    $flat = (double) $row1['latitude'] ;
    $flong =(double) $row1['longitude'];
    ...
    $tlat =(double) $row2['latitude'] ;
    $tlong = (double) $row2['longitude'];
...
<body>
<a href = "unregroutemaps.php"><button>Back</button></a>
